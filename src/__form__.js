 ...
 * 
 * 
 * 2.  controlled element : use individual field state for 
 * each input field 
 * 
 * 3. controlled element : one object in a state holding 
 * all the input fields value 
 * 
 * 4. uncontrolled element : useRef to create a reference 
 * to the element and access value by using like : nameRef.current.value
 * 
 * 
